...
openChatBtn.addEventListener("click", function(event) {
  chatContainer.style.display = "block";
  // Restaurer l'historique précédent du chat ici si nécessaire
  // Par exemple, vous pouvez appeler une fonction pour charger l'historique depuis le stockage local
});
...
// Déclaration d'une variable globale pour stocker les messages
let chatHistory = [];
